...
mongoose.connect(
  "mongodb+srv://vasumitraviramalli:vasumitra2003@cluster0.mws8ywt.mongodb.net/?retryWrites=true&w=majority"
);
  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: "http://localhost:3000//auth/google/vasuwebpage",
...
app.post("/login", (req, res) => {
  ...
  req.login(user, function (err) {
    if (err) {
      alert(
        "Try to enter correct username and password! If you don't have account signup and enjoy!!"
      );
      // console.log(err);
      res.redirect("/login");
    } else {
